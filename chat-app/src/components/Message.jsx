...
const Message = () => {
  return (
       <div>
        ...
        <div className='bg-white px-4 py-2 rounded-lg font-semibold w-[300px]'>Let me know if you need something</div>
    </div>
    {/* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */}
    <div className='flex items-center gap-4 p-4 justify-end'>
       
        <div className='bg-blue-500 text-white px-4 py-2 rounded-lg font-semibold w-[300px]'>No thanks i,m okay</div>
        <div>
